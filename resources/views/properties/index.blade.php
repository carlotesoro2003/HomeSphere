        ...
        <div class="card shadow-xl rounded-lg overflow-hidden">
            <div class="card-body p-4">
                ...
                <div class="card-actions   mt-4">
                    ...
                    <button type="button" class="btn btn-error text-sm" onclick="confirmDelete({{ $property->id }})">Delete</button>
                </div>
            </div>
        </div>
    @endforeach
...
<div id="deleteConfirmationModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center opacity-0 pointer-events-none transition-all duration-300 hidden">
